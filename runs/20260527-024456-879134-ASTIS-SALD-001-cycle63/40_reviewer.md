...
```bash
python3 tools/astis.py agent-note 20260527-024456-879134-ASTIS-SALD-001-cycle63 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260527-024456-879134-ASTIS-SALD-001-cycle63 --notes "..."
```
