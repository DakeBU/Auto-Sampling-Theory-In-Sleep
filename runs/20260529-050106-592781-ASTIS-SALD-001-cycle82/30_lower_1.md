...
```bash
python3 tools/astis.py agent-note 20260529-050106-592781-ASTIS-SALD-001-cycle82 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260529-050106-592781-ASTIS-SALD-001-cycle82 --notes "..."
```
