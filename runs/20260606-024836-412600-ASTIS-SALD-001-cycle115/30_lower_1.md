...
```bash
python3 tools/astis.py agent-note 20260606-024836-412600-ASTIS-SALD-001-cycle115 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260606-024836-412600-ASTIS-SALD-001-cycle115 --notes "..."
```
