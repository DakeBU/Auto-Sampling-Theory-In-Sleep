...
```bash
python3 tools/astis.py agent-note 20260605-020608-578536-ASTIS-SALD-001-cycle106 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260605-020608-578536-ASTIS-SALD-001-cycle106 --notes "..."
```
