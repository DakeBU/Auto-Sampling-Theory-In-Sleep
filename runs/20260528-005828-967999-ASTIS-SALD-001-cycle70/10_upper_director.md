...
```bash
python3 tools/astis.py agent-note 20260528-005828-967999-ASTIS-SALD-001-cycle70 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260528-005828-967999-ASTIS-SALD-001-cycle70 --notes "..."
```
