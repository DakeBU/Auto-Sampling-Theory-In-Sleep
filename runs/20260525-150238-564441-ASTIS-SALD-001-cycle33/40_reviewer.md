...
```bash
python3 tools/astis.py agent-note 20260525-150238-564441-ASTIS-SALD-001-cycle33 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260525-150238-564441-ASTIS-SALD-001-cycle33 --notes "..."
```
