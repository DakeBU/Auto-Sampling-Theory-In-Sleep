...
```bash
python3 tools/astis.py agent-note 20260603-030313-201785-ASTIS-SALD-001-cycle94 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260603-030313-201785-ASTIS-SALD-001-cycle94 --notes "..."
```
