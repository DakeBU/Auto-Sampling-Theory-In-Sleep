...
```bash
python3 tools/astis.py agent-note 20260524-231714-576974-ASTIS-SALD-001-cycle12 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260524-231714-576974-ASTIS-SALD-001-cycle12 --notes "..."
```
