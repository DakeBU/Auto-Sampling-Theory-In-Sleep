...
```bash
python3 tools/astis.py agent-note 20260527-045129-965421-ASTIS-SALD-001-cycle68 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260527-045129-965421-ASTIS-SALD-001-cycle68 --notes "..."
```
