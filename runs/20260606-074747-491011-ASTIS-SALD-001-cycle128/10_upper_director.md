...
```bash
python3 tools/astis.py agent-note 20260606-074747-491011-ASTIS-SALD-001-cycle128 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260606-074747-491011-ASTIS-SALD-001-cycle128 --notes "..."
```
