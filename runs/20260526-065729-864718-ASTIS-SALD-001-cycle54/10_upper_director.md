...
```bash
python3 tools/astis.py agent-note 20260526-065729-864718-ASTIS-SALD-001-cycle54 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260526-065729-864718-ASTIS-SALD-001-cycle54 --notes "..."
```
