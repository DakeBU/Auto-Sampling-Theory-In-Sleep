...
```bash
python3 tools/astis.py agent-note 20260603-000428-044416-ASTIS-SALD-001-cycle87 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260603-000428-044416-ASTIS-SALD-001-cycle87 --notes "..."
```
