...
```bash
python3 tools/astis.py agent-note 20260526-031358-753548-ASTIS-SALD-001-cycle45 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260526-031358-753548-ASTIS-SALD-001-cycle45 --notes "..."
```
