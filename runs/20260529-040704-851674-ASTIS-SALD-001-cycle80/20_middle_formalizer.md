...
```bash
python3 tools/astis.py agent-note 20260529-040704-851674-ASTIS-SALD-001-cycle80 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260529-040704-851674-ASTIS-SALD-001-cycle80 --notes "..."
```
