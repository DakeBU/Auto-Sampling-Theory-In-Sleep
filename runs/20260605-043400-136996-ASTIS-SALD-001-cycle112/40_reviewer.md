...
```bash
python3 tools/astis.py agent-note 20260605-043400-136996-ASTIS-SALD-001-cycle112 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260605-043400-136996-ASTIS-SALD-001-cycle112 --notes "..."
```
