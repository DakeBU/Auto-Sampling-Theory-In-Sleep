...
```bash
python3 tools/astis.py agent-note 20260607-233935-482061-ASTIS-SALD-001-cycle140 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260607-233935-482061-ASTIS-SALD-001-cycle140 --notes "..."
```
