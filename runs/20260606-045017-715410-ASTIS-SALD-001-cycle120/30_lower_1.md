...
```bash
python3 tools/astis.py agent-note 20260606-045017-715410-ASTIS-SALD-001-cycle120 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260606-045017-715410-ASTIS-SALD-001-cycle120 --notes "..."
```
