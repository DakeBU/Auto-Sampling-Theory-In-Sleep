...
```bash
python3 tools/astis.py agent-note 20260529-000453-025296-ASTIS-SALD-001-cycle71 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260529-000453-025296-ASTIS-SALD-001-cycle71 --notes "..."
```
