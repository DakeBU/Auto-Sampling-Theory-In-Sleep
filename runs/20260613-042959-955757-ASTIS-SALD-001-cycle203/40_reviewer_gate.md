...
Role: reviewer_gate
Base role: reviewer
Run directory: runs/20260613-042959-955757-ASTIS-SALD-001-cycle203
...
```text
2026-06-13 04:29:07 reviewer_gate/build compiled gate=pass :: Cycle 202 mandatory reviewer gate: python3 tools/astis.py check passed. Build completed successfully for lake build and Tests; ASTIS fake-proof scan passed.
2026-06-13 04:29:25 reviewer_gate/handoff queued gate=pass :: narrows-source-cited-boundary reviewer acceptance after gate pass: accepted cycle-202 dynamic-leaf worker packet. Exact boundary narrowed: hSourceTaylorIntegrandRawDef is reduced through compiled SALD.selectedWeakTestSourceTaylorIntegrandRawDefOfSelectedIncrementEndpointAndLineDef and SALD.selectedWeakTestSelectedIncrementCoordinateLineDefOfEndpointAndLineDef to the smaller source-cited hSelectedEndpointCoordinate...
2026-06-13 04:29:43 reviewer_gate/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=133.3.
2026-06-13 04:29:54 reviewer/build compiled gate=pass :: Cycle build gate.
```

Compact context pack: `runs/20260613-042959-955757-ASTIS-SALD-001-cycle203/05_context_pack.md`
...
Shared dialogue board: `runs/20260613-042959-955757-ASTIS-SALD-001-cycle203/dialogue.md`

When finished, append a handoff:

```bash
python3 tools/astis.py agent-note 20260613-042959-955757-ASTIS-SALD-001-cycle203 --role reviewer_gate --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer_gate --kind handoff --status queued --artifact runs/20260613-042959-955757-ASTIS-SALD-001-cycle203 --notes "..."
```
