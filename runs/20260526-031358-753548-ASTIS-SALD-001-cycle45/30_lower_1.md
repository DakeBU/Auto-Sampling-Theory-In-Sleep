...
```bash
python3 tools/astis.py agent-note 20260526-031358-753548-ASTIS-SALD-001-cycle45 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260526-031358-753548-ASTIS-SALD-001-cycle45 --notes "..."
```
