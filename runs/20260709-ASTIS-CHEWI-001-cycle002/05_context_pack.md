...
Log-concave sampling foundation cycle: CONV/MEAS Prekopa-Leindler port audit. Use Mathlib first and `Lean-Asymptotic-Statistical-Theory/ForMathlib/PrekopaLeindler.lean` as provenance only. Select one smallest local ASTIS-owned lemma.
