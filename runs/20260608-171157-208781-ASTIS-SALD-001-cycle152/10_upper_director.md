...
```bash
python3 tools/astis.py agent-note 20260608-171157-208781-ASTIS-SALD-001-cycle152 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260608-171157-208781-ASTIS-SALD-001-cycle152 --notes "..."
```
