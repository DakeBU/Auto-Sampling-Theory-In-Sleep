...
```bash
python3 tools/astis.py agent-note 20260605-004022-692256-ASTIS-SALD-001-cycle102 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260605-004022-692256-ASTIS-SALD-001-cycle102 --notes "..."
```
