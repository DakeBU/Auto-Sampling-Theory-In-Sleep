...
```bash
python3 tools/astis.py agent-note 20260613-020958-527485-ASTIS-SALD-001-cycle196 --role middle_formalizer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle_formalizer --kind handoff --status queued --artifact runs/20260613-020958-527485-ASTIS-SALD-001-cycle196 --notes "..."
```
...
Middle profile: coordinator synthesis. If middle-panel specialist prompts or handoffs exist, read them first. Synthesize source correspondence, technical-lemma retrieval, and report/export status into one lower_1 natural-language task, one lower_2 Lean implementation task, and optionally one lower_3 technical-lemma/API scout task. If no panel ran, keep this lightweight and focus on the active proof leaf.
