...
```bash
python3 tools/astis.py agent-note 20260606-053049-550853-ASTIS-SALD-001-cycle122 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260606-053049-550853-ASTIS-SALD-001-cycle122 --notes "..."
```
