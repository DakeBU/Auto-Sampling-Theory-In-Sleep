...
```bash
python3 tools/astis.py agent-note 20260605-050224-371546-ASTIS-SALD-001-cycle113 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260605-050224-371546-ASTIS-SALD-001-cycle113 --notes "..."
```
