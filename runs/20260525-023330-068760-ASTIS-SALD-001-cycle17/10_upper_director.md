...
```bash
python3 tools/astis.py agent-note 20260525-023330-068760-ASTIS-SALD-001-cycle17 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260525-023330-068760-ASTIS-SALD-001-cycle17 --notes "..."
```
