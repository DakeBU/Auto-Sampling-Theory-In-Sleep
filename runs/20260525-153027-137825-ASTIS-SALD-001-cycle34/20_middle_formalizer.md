...
```bash
python3 tools/astis.py agent-note 20260525-153027-137825-ASTIS-SALD-001-cycle34 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260525-153027-137825-ASTIS-SALD-001-cycle34 --notes "..."
```
