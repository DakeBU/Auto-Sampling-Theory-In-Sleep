...
```bash
python3 tools/astis.py agent-note 20260524-203014-425914-ASTIS-SALD-001-cycle05 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260524-203014-425914-ASTIS-SALD-001-cycle05 --notes "..."
```
