...
```bash
python3 tools/astis.py agent-note 20260603-012201-383841-ASTIS-SALD-001-cycle90 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260603-012201-383841-ASTIS-SALD-001-cycle90 --notes "..."
```
