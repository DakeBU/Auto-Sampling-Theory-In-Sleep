...
```bash
python3 tools/astis.py agent-note 20260606-081800-370544-ASTIS-SALD-001-cycle129 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260606-081800-370544-ASTIS-SALD-001-cycle129 --notes "..."
```
