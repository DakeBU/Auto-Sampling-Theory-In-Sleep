...
```bash
python3 tools/astis.py agent-note 20260528-005800-122204-ASTIS-SALD-001-cycle70 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260528-005800-122204-ASTIS-SALD-001-cycle70 --notes "..."
```
