...
```bash
python3 tools/astis.py agent-note 20260604-234946-598823-ASTIS-SALD-001-cycle100 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260604-234946-598823-ASTIS-SALD-001-cycle100 --notes "..."
```
