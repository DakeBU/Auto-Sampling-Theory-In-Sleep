...
```bash
python3 tools/astis.py agent-note 20260608-041314-014362-ASTIS-SALD-001-cycle148 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260608-041314-014362-ASTIS-SALD-001-cycle148 --notes "..."
```
