...
```bash
python3 tools/astis.py agent-note 20260602-232921-337363-ASTIS-SALD-001-cycle86 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260602-232921-337363-ASTIS-SALD-001-cycle86 --notes "..."
```
