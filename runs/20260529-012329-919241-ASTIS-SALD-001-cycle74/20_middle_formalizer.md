...
```bash
python3 tools/astis.py agent-note 20260529-012329-919241-ASTIS-SALD-001-cycle74 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260529-012329-919241-ASTIS-SALD-001-cycle74 --notes "..."
```
