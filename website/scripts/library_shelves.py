...
<article class="library-index-card"><div class="portal-kicker">Pinned arXiv monograph</div><h2>Discrete Sampling</h2><p>Finite-state Gibbs and Glauber dynamics, Ising, hard-core and matroid sampling with shared kernel, spectral and entropy foundations.</p><a class="button" href="discrete-sampling/index.html">Open library</a></article>
</section>
...
<article><h3>Chen · Štefankovič · Vigoda</h3><p>The Discrete Sampling source is <em>Spectral Independence and Local-to-Global Techniques for Optimal Mixing of Markov Chains</em>, arXiv:2307.13826v4. Pal–Mesikepp arXiv:2510.14165v1 is a beginner companion. The Ising survey in §12 requires its cited original proofs.</p><a href="https://arxiv.org/abs/2307.13826v4">Pinned monograph ↗</a></article>
...
<article class="source-portal source-portal-discrete"><div class="portal-kicker">Pinned arXiv monograph</div><h2>Discrete Sampling</h2><p>Chen · Štefankovič · Vigoda. Ising and finite-state Gibbs samplers; spectral independence and shared functional inequalities.</p><div class="portal-actions"><a class="button" href="libraries/discrete-sampling/index.html">Open library</a></div></article>
</section>
"""
...
def validate(output: Path) -> None:
    ...
    required = {
        ...
        "libraries/discrete-sampling/index.html": ("Discrete Sampling", "Chen", "chapter environment established"),
