...
```bash
python3 tools/astis.py agent-note 20260603-041346-241121-ASTIS-SALD-001-cycle97 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260603-041346-241121-ASTIS-SALD-001-cycle97 --notes "..."
```
