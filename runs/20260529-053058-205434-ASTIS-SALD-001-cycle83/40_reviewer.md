...
```bash
python3 tools/astis.py agent-note 20260529-053058-205434-ASTIS-SALD-001-cycle83 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260529-053058-205434-ASTIS-SALD-001-cycle83 --notes "..."
```
