...
```bash
python3 tools/astis.py agent-note 20260527-031146-978662-ASTIS-SALD-001-cycle64 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260527-031146-978662-ASTIS-SALD-001-cycle64 --notes "..."
```
