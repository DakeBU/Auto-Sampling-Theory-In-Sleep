...
```bash
python3 tools/astis.py agent-note 20260602-230207-442976-ASTIS-SALD-001-cycle85 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260602-230207-442976-ASTIS-SALD-001-cycle85 --notes "..."
```
