...
```bash
python3 tools/astis.py agent-note 20260527-003212-802235-ASTIS-SALD-001-cycle58 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260527-003212-802235-ASTIS-SALD-001-cycle58 --notes "..."
```
