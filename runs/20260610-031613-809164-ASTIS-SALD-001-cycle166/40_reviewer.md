...
```bash
python3 tools/astis.py agent-note 20260610-031613-809164-ASTIS-SALD-001-cycle166 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260610-031613-809164-ASTIS-SALD-001-cycle166 --notes "..."
```
