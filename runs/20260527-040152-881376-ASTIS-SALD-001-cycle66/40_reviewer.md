...
```bash
python3 tools/astis.py agent-note 20260527-040152-881376-ASTIS-SALD-001-cycle66 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260527-040152-881376-ASTIS-SALD-001-cycle66 --notes "..."
```
