...
```bash
python3 tools/astis.py agent-note 20260605-031605-885746-ASTIS-SALD-001-cycle109 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260605-031605-885746-ASTIS-SALD-001-cycle109 --notes "..."
```
