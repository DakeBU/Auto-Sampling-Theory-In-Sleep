...
```bash
python3 tools/astis.py agent-note 20260613-030756-260318-ASTIS-SALD-001-cycle199 --role upper_director --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper_director --kind handoff --status queued --artifact runs/20260613-030756-260318-ASTIS-SALD-001-cycle199 --notes "..."
```
