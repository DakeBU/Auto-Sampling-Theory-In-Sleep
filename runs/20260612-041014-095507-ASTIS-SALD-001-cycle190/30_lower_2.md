...
```bash
python3 tools/astis.py agent-note 20260612-041014-095507-ASTIS-SALD-001-cycle190 --role lower_2 --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower_2 --kind handoff --status queued --artifact runs/20260612-041014-095507-ASTIS-SALD-001-cycle190 --notes "..."
```
