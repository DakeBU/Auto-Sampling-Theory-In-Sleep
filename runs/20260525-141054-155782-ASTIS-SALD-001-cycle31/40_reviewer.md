...
```bash
python3 tools/astis.py agent-note 20260525-141054-155782-ASTIS-SALD-001-cycle31 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260525-141054-155782-ASTIS-SALD-001-cycle31 --notes "..."
```
