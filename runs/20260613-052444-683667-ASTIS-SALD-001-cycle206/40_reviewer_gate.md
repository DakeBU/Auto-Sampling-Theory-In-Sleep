...
Role: reviewer_gate
Base role: reviewer
Run directory: runs/20260613-052444-683667-ASTIS-SALD-001-cycle206
...
```text
2026-06-13 05:23:03 reviewer_gate/handoff queued gate=pass :: narrows-source-cited-boundary reviewer acceptance after gate pass: accepted cycle-205 dynamic-leaf worker packet. Exact boundary narrowed: hSelectedLineTaylorRawSplitDef is recorded by compiled SALD.cycle205GeneralMovingTargetDiscreteEmGeneratorLaplacianEventFieldFrozenScalarBrownianItoSelectedLineTaylorRawSplitLower2Obligation/Dag with typed feedback leaf=hSelectedLineTaylorRawSplitDef error_class=source_contract...
2026-06-13 05:23:29 reviewer_gate/handoff queued gate=pass :: narrows-source-cited-boundary reviewer acceptance after gate pass: accepted cycle-205 dynamic-leaf worker packet. Exact boundary narrowed: hSelectedLineTaylorRawSplitDef is recorded by compiled SALD.cycle205GeneralMovingTargetDiscreteEmGeneratorLaplacianEventFieldFrozenScalarBrownianItoSelectedLineTaylorRawSplitLower2Obligation/Dag with typed feedback leaf=hSelectedLineTaylorRawSplitDef error_class=source_contract...
2026-06-13 05:24:27 reviewer_gate/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=211.4.
2026-06-13 05:24:38 reviewer/build compiled gate=pass :: Cycle build gate.
```

Compact context pack: `runs/20260613-052444-683667-ASTIS-SALD-001-cycle206/05_context_pack.md`
...
Shared dialogue board: `runs/20260613-052444-683667-ASTIS-SALD-001-cycle206/dialogue.md`

When finished, append a handoff:

```bash
python3 tools/astis.py agent-note 20260613-052444-683667-ASTIS-SALD-001-cycle206 --role reviewer_gate --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer_gate --kind handoff --status queued --artifact runs/20260613-052444-683667-ASTIS-SALD-001-cycle206 --notes "..."
```
