...
```bash
python3 tools/astis.py agent-note 20260610-013325-927883-ASTIS-SALD-001-cycle163 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260610-013325-927883-ASTIS-SALD-001-cycle163 --notes "..."
```
