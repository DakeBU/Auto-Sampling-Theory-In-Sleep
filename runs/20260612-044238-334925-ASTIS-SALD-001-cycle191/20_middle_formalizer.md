...
```bash
python3 tools/astis.py agent-note 20260612-044238-334925-ASTIS-SALD-001-cycle191 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260612-044238-334925-ASTIS-SALD-001-cycle191 --notes "..."
```
