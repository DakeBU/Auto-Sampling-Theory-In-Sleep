...
```bash
python3 tools/astis.py agent-note 20260526-234221-833521-ASTIS-SALD-001-cycle56 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260526-234221-833521-ASTIS-SALD-001-cycle56 --notes "..."
```
