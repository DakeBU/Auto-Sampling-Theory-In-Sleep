...
```bash
python3 tools/astis.py agent-note 20260527-015331-771246-ASTIS-SALD-001-cycle61 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260527-015331-771246-ASTIS-SALD-001-cycle61 --notes "..."
```
