...
```bash
python3 tools/astis.py agent-note 20260529-043409-488712-ASTIS-SALD-001-cycle81 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260529-043409-488712-ASTIS-SALD-001-cycle81 --notes "..."
```
