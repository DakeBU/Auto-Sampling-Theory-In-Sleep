...
```bash
python3 tools/astis.py agent-note 20260604-232154-315438-ASTIS-SALD-001-cycle99 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260604-232154-315438-ASTIS-SALD-001-cycle99 --notes "..."
```
