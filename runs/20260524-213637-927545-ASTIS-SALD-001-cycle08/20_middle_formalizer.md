...
```bash
python3 tools/astis.py agent-note 20260524-213637-927545-ASTIS-SALD-001-cycle08 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260524-213637-927545-ASTIS-SALD-001-cycle08 --notes "..."
```
