...
```bash
python3 tools/astis.py agent-note 20260608-204342-155485-ASTIS-SALD-001-cycle159 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260608-204342-155485-ASTIS-SALD-001-cycle159 --notes "..."
```
