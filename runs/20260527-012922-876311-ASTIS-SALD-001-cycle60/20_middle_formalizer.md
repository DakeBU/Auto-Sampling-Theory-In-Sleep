...
```bash
python3 tools/astis.py agent-note 20260527-012922-876311-ASTIS-SALD-001-cycle60 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260527-012922-876311-ASTIS-SALD-001-cycle60 --notes "..."
```
