...
```bash
python3 tools/astis.py agent-note 20260526-234149-777120-ASTIS-SALD-001-cycle56 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260526-234149-777120-ASTIS-SALD-001-cycle56 --notes "..."
```
