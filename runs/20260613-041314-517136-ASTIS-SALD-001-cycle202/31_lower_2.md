...
```bash
python3 tools/astis.py agent-note 20260613-041314-517136-ASTIS-SALD-001-cycle202 --role lower_2 --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower_2 --kind handoff --status queued --artifact runs/20260613-041314-517136-ASTIS-SALD-001-cycle202 --notes "..."
```
