...
Log-concave sampling foundation cycle: PATH/GAUSS path-space change of measure. Extend the compiled finite-dimensional Gaussian/Girsanov cylinder leaves toward Brownian path-space RN derivatives only through explicit source contracts.
