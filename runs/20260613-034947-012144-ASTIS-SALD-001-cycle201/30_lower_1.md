...
```bash
python3 tools/astis.py agent-note 20260613-034947-012144-ASTIS-SALD-001-cycle201 --role lower_1 --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower_1 --kind handoff --status queued --artifact runs/20260613-034947-012144-ASTIS-SALD-001-cycle201 --notes "..."
```
