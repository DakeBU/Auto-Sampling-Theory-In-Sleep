...
```bash
python3 tools/astis.py agent-note 20260526-062835-739967-ASTIS-SALD-001-cycle53 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260526-062835-739967-ASTIS-SALD-001-cycle53 --notes "..."
```
