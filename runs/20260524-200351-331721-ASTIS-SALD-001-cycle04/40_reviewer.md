...
```bash
python3 tools/astis.py agent-note 20260524-200351-331721-ASTIS-SALD-001-cycle04 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260524-200351-331721-ASTIS-SALD-001-cycle04 --notes "..."
```
