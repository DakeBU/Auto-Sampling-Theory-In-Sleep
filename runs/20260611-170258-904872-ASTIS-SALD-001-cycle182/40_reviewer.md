...
```bash
python3 tools/astis.py agent-note 20260611-170258-904872-ASTIS-SALD-001-cycle182 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260611-170258-904872-ASTIS-SALD-001-cycle182 --notes "..."
```
