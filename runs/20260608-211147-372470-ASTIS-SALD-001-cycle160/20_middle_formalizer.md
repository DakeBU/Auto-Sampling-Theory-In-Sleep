...
```bash
python3 tools/astis.py agent-note 20260608-211147-372470-ASTIS-SALD-001-cycle160 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260608-211147-372470-ASTIS-SALD-001-cycle160 --notes "..."
```
