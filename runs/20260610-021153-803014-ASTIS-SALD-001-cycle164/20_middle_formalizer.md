...
```bash
python3 tools/astis.py agent-note 20260610-021153-803014-ASTIS-SALD-001-cycle164 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260610-021153-803014-ASTIS-SALD-001-cycle164 --notes "..."
```
