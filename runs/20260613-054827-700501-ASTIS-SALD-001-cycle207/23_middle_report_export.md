...
```bash
python3 tools/astis.py agent-note 20260613-054827-700501-ASTIS-SALD-001-cycle207 --role middle_report_export --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle_report_export --kind handoff --status queued --artifact runs/20260613-054827-700501-ASTIS-SALD-001-cycle207 --notes "..."
```
...
Middle-panel profile: report/export maintainer. Focus only on human-readable outputs: Chinese 6h report, Markdown status, article update, technical report snippets, and which raw logs should not be human entry points. Explain open blockers in plain language for non-Lean readers. Do not assign Lean work and do not polish prose during inner proof search; this role is mainly for final-audit synchronization.
