# Next Todo Packet: ASTIS-CHEWI-001 cycle 12

Generated: `2026-07-10 02:43:01`

## Human Default

Choose the smallest Lean leaf that advances the log-concave sampling textbook reconstruction.  Prefer shared roots that will serve multiple chapters, but keep the target narrow enough to compile or to expose one precise red cited theorem boundary.
...
Write the natural-language proof route for the active textbook chapter leaf.  Name the theorem, cited source, shared roots, and the minimal Lean declarations needed.
