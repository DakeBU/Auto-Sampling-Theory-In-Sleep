...
```bash
python3 tools/astis.py agent-note 20260608-012535-292854-ASTIS-SALD-001-cycle143 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260608-012535-292854-ASTIS-SALD-001-cycle143 --notes "..."
```
