...
```bash
python3 tools/astis.py agent-note 20260613-050236-675526-ASTIS-SALD-001-cycle205 --role reviewer_gate --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer_gate --kind handoff --status queued --artifact runs/20260613-050236-675526-ASTIS-SALD-001-cycle205 --notes "..."
```
