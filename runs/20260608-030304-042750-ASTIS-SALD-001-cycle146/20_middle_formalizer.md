...
```bash
python3 tools/astis.py agent-note 20260608-030304-042750-ASTIS-SALD-001-cycle146 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260608-030304-042750-ASTIS-SALD-001-cycle146 --notes "..."
```
