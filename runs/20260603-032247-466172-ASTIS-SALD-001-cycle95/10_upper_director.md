...
```bash
python3 tools/astis.py agent-note 20260603-032247-466172-ASTIS-SALD-001-cycle95 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260603-032247-466172-ASTIS-SALD-001-cycle95 --notes "..."
```
