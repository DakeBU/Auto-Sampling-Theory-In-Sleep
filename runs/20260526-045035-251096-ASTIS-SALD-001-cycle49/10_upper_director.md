...
```bash
python3 tools/astis.py agent-note 20260526-045035-251096-ASTIS-SALD-001-cycle49 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260526-045035-251096-ASTIS-SALD-001-cycle49 --notes "..."
```
