...
```bash
python3 tools/astis.py agent-note 20260613-024704-572927-ASTIS-SALD-001-cycle198 --role middle_formalizer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle_formalizer --kind handoff --status queued --artifact runs/20260613-024704-572927-ASTIS-SALD-001-cycle198 --notes "..."
```
