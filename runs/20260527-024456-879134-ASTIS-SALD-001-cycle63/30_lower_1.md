...
```bash
python3 tools/astis.py agent-note 20260527-024456-879134-ASTIS-SALD-001-cycle63 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260527-024456-879134-ASTIS-SALD-001-cycle63 --notes "..."
```
