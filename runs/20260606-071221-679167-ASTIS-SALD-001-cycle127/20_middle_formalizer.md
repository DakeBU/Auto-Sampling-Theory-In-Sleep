...
```bash
python3 tools/astis.py agent-note 20260606-071221-679167-ASTIS-SALD-001-cycle127 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260606-071221-679167-ASTIS-SALD-001-cycle127 --notes "..."
```
