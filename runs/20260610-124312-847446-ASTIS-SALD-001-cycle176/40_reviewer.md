...
```bash
python3 tools/astis.py agent-note 20260610-124312-847446-ASTIS-SALD-001-cycle176 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260610-124312-847446-ASTIS-SALD-001-cycle176 --notes "..."
```
