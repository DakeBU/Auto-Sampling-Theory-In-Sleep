...
```bash
python3 tools/astis.py agent-note 20260529-015453-735157-ASTIS-SALD-001-cycle75 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260529-015453-735157-ASTIS-SALD-001-cycle75 --notes "..."
```
