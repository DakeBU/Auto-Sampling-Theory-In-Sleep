...
This changes presentation/provenance surfaces only. It does not rewrite Lean
sources, theorem statements, graph evidence, source maps, or mathematical
status. Run normal site/Lean validation first, then this script, then browser
and identity checks on the resulting review site.
"""
...
def rewrite_text(text: str, *, is_html: bool) -> str:
    ...
    text = re.sub(
        r"159223240\+anonymous@users\.noreply\.github\.com",
