...
```bash
python3 tools/astis.py agent-note 20260608-191305-376032-ASTIS-SALD-001-cycle156 --role lower_1 --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower_1 --kind handoff --status queued --artifact runs/20260608-191305-376032-ASTIS-SALD-001-cycle156 --notes "..."
```
