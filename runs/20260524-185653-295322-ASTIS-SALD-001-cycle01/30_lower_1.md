...
```bash
python3 tools/astis.py agent-note 20260524-185653-295322-ASTIS-SALD-001-cycle01 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260524-185653-295322-ASTIS-SALD-001-cycle01 --notes "..."
```
