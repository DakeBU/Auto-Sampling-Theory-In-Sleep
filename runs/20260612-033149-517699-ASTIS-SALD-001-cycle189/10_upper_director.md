...
```bash
python3 tools/astis.py agent-note 20260612-033149-517699-ASTIS-SALD-001-cycle189 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260612-033149-517699-ASTIS-SALD-001-cycle189 --notes "..."
```
