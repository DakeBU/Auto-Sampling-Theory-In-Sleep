...
```bash
python3 tools/astis.py agent-note 20260610-153644-620399-ASTIS-SALD-001-cycle181 --role lower_1 --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower_1 --kind handoff --status queued --artifact runs/20260610-153644-620399-ASTIS-SALD-001-cycle181 --notes "..."
```
