...
```bash
python3 tools/astis.py agent-note 20260525-054346-068248-ASTIS-SALD-001-cycle25 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260525-054346-068248-ASTIS-SALD-001-cycle25 --notes "..."
```
