...
```bash
python3 tools/astis.py agent-note 20260529-034350-055074-ASTIS-SALD-001-cycle79 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260529-034350-055074-ASTIS-SALD-001-cycle79 --notes "..."
```
