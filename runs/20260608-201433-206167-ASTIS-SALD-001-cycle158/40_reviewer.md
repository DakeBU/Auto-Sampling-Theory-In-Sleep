...
Role: reviewer
Base role: reviewer
Run directory: runs/20260608-201433-206167-ASTIS-SALD-001-cycle158
...
```text
2026-06-08 20:11:19 lower/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=420.4.
2026-06-08 20:13:59 reviewer/handoff queued gate=not-run :: narrows-source-cited-boundary reviewer acceptance after mandatory gate. Accepted cycle-157 illness-area refiner: hemGeneratorLaplacianEventFieldStdBasisDef narrowed to hEmGeneratorLaplacianEventFieldPointwiseStdBasisDef, then hemGeneratorLaplacianEventFieldEqLaplacian narrowed to hEmGeneratorLaplacianEventFieldPointwiseEqLaplacian through compiled SALD.generalMovingTargetDiscreteEmGeneratorLaplacianEventFieldEqLap...
2026-06-08 20:14:23 reviewer/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=183.7.
2026-06-08 20:14:33 reviewer/build compiled gate=pass :: Cycle build gate.
```

Compact context pack: `runs/20260608-201433-206167-ASTIS-SALD-001-cycle158/05_context_pack.md`
...
Shared dialogue board: `runs/20260608-201433-206167-ASTIS-SALD-001-cycle158/dialogue.md`

When finished, append a handoff:

```bash
python3 tools/astis.py agent-note 20260608-201433-206167-ASTIS-SALD-001-cycle158 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260608-201433-206167-ASTIS-SALD-001-cycle158 --notes "..."
```
