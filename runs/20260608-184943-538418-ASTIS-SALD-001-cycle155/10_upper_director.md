...
```bash
python3 tools/astis.py agent-note 20260608-184943-538418-ASTIS-SALD-001-cycle155 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260608-184943-538418-ASTIS-SALD-001-cycle155 --notes "..."
```
