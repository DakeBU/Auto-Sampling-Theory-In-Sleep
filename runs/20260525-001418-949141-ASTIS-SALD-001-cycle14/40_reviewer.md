...
```bash
python3 tools/astis.py agent-note 20260525-001418-949141-ASTIS-SALD-001-cycle14 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260525-001418-949141-ASTIS-SALD-001-cycle14 --notes "..."
```
