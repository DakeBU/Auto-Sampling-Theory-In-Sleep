...
```bash
python3 tools/astis.py agent-note 20260606-040438-539131-ASTIS-SALD-001-cycle118 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260606-040438-539131-ASTIS-SALD-001-cycle118 --notes "..."
```
