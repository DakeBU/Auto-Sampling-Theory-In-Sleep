...
```bash
python3 tools/astis.py agent-note 20260612-053029-174468-ASTIS-SALD-001-cycle193 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260612-053029-174468-ASTIS-SALD-001-cycle193 --notes "..."
```
