...
Log-concave sampling foundation cycle: chapter map and shared-root lock. Keep `research-wiki/sampling-sde-library/log_concave_sampling_overview.md`, the chapter DAG, and the blue/red status tree synchronized. No proof work should bypass the shared roots.
