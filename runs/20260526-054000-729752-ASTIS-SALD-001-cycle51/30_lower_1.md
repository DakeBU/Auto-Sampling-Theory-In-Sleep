...
```bash
python3 tools/astis.py agent-note 20260526-054000-729752-ASTIS-SALD-001-cycle51 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260526-054000-729752-ASTIS-SALD-001-cycle51 --notes "..."
```
