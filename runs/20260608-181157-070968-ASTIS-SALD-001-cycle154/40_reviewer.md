...
Role: reviewer
Base role: reviewer
Run directory: runs/20260608-181157-070968-ASTIS-SALD-001-cycle154
...
```text
2026-06-08 18:09:21 lower/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=395.6.
2026-06-08 18:11:12 reviewer/handoff queued gate=not-run :: narrows-source-cited-boundary reviewer acceptance after mandatory gate. Accepted cycle-153 dynamic-leaf lower_2 packet: SALD.generalMovingTargetDiscreteEmGeneratorLaplacianStateIntegralOfSourceFunctional narrows hemGeneratorLaplacianStateIntegral to hemGeneratorSourceActionDef plus hsourceLaplacianFunctional/hsourceLaplacianFieldMeas/hhatRhoS/hhatX; SALD.generalMovingTargetDiscreteEmGeneratorLaplacianStateIntegral...
2026-06-08 18:11:46 reviewer/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=145.1.
2026-06-08 18:11:57 reviewer/build compiled gate=pass :: Cycle build gate.
```

Compact context pack: `runs/20260608-181157-070968-ASTIS-SALD-001-cycle154/05_context_pack.md`
...
Shared dialogue board: `runs/20260608-181157-070968-ASTIS-SALD-001-cycle154/dialogue.md`

When finished, append a handoff:

```bash
python3 tools/astis.py agent-note 20260608-181157-070968-ASTIS-SALD-001-cycle154 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260608-181157-070968-ASTIS-SALD-001-cycle154 --notes "..."
```
