...
Ported to ASTIS by Dake Bu and contributors.
-/
module
...
/-!
# Doob's Lᵖ maximal inequality (ASTIS compatibility port)

This file is a compatibility port of the complete proof proposed in Mathlib4
PR #39349 (`4b63335c679c15aab74a00d37714d41aa99d701d`).  The proposal was not
merged into the Mathlib revision pinned by ASTIS.  Keeping the general proof
here makes the exact provenance and the API adaptation visible; ASTIS exposes
its sampling-facing `p = 2` specialization in `DiscreteDoobL2`.
