...
```bash
python3 tools/astis.py agent-note 20260608-023441-773831-ASTIS-SALD-001-cycle145 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260608-023441-773831-ASTIS-SALD-001-cycle145 --notes "..."
```
