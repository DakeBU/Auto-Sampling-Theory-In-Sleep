...
```bash
python3 tools/astis.py agent-note 20260527-042752-381318-ASTIS-SALD-001-cycle67 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260527-042752-381318-ASTIS-SALD-001-cycle67 --notes "..."
```
