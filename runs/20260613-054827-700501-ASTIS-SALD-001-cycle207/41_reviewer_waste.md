...
```bash
python3 tools/astis.py agent-note 20260613-054827-700501-ASTIS-SALD-001-cycle207 --role reviewer_waste --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer_waste --kind handoff --status queued --artifact runs/20260613-054827-700501-ASTIS-SALD-001-cycle207 --notes "..."
```
...
Specialization: you are the progress-economics reviewer. Audit whether the cycle spent time on the best active SALD leaf, duplicated previous wrappers, replayed old context, or ignored existing technical lemma memory. Record a plain-language waste diagnosis for the 6h Chinese report: what improved, what did not improve, and which next leaf has the best expected value.
