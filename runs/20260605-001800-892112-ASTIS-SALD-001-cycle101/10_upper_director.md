...
```bash
python3 tools/astis.py agent-note 20260605-001800-892112-ASTIS-SALD-001-cycle101 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260605-001800-892112-ASTIS-SALD-001-cycle101 --notes "..."
```
