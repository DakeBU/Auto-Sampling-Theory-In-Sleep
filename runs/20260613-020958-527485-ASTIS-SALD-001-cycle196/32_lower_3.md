...
```bash
python3 tools/astis.py agent-note 20260613-020958-527485-ASTIS-SALD-001-cycle196 --role lower_3 --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower_3 --kind handoff --status queued --artifact runs/20260613-020958-527485-ASTIS-SALD-001-cycle196 --notes "..."
```
