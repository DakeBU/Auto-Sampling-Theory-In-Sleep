...
```bash
python3 tools/astis.py agent-note 20260606-063453-698046-ASTIS-SALD-001-cycle125 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260606-063453-698046-ASTIS-SALD-001-cycle125 --notes "..."
```
