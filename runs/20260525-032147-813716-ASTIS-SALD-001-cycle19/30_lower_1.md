...
```bash
python3 tools/astis.py agent-note 20260525-032147-813716-ASTIS-SALD-001-cycle19 --role lower --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role lower --kind handoff --status queued --artifact runs/20260525-032147-813716-ASTIS-SALD-001-cycle19 --notes "..."
```
