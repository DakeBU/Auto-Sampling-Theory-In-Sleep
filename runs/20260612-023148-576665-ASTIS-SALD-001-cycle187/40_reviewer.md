...
```text
2026-06-12 02:29:17 lower/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=702.4.
2026-06-12 02:31:16 reviewer/handoff queued gate=not-run :: narrows-source-cited-boundary reviewer acceptance after gate pass: accepted cycle-186 dynamic-leaf worker packet. hSourceTaylorIntegrandPointwise narrowed by compiled SALD.selectedWeakTestSourceTaylorIntegrandPointwiseOfLineTermDefs to hSourceTaylorIntegrandDef, hSourceLinearTermDef, and hSourceQuadraticTermDef; hSourceLinearTermDef further narrowed by compiled SALD.selectedWeakTestSourceLinearTermDefOfScalarLineF...
2026-06-12 02:31:31 reviewer/attempt accepted gate=not-run :: External agent command exit code 0. active_agent_seconds=133.6.
2026-06-12 02:31:42 reviewer/build compiled gate=pass :: Cycle build gate.
```

Compact context pack: `runs/20260612-023148-576665-ASTIS-SALD-001-cycle187/05_context_pack.md`
...
Shared dialogue board: `runs/20260612-023148-576665-ASTIS-SALD-001-cycle187/dialogue.md`

When finished, append a handoff:

```bash
python3 tools/astis.py agent-note 20260612-023148-576665-ASTIS-SALD-001-cycle187 --role reviewer --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role reviewer --kind handoff --status queued --artifact runs/20260612-023148-576665-ASTIS-SALD-001-cycle187 --notes "..."
```
