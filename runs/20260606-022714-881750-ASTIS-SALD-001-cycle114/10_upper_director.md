...
```bash
python3 tools/astis.py agent-note 20260606-022714-881750-ASTIS-SALD-001-cycle114 --role upper --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role upper --kind handoff --status queued --artifact runs/20260606-022714-881750-ASTIS-SALD-001-cycle114 --notes "..."
```
