...
```bash
python3 tools/astis.py agent-note 20260524-211245-280619-ASTIS-SALD-001-cycle07 --role middle --message "..."
python3 tools/astis.py trial-log --task ASTIS-SALD-001 --role middle --kind handoff --status queued --artifact runs/20260524-211245-280619-ASTIS-SALD-001-cycle07 --notes "..."
```
